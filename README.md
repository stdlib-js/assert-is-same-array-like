...
```javascript
import isSameArrayLike from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-same-array-like@v0.1.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/assert-is-same-array-like/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/assert-is-same-array-like/actions/workflows/test.yml?query=branch:v0.1.1
